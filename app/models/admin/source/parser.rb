...
class Admin::Source::Parser < Struct.new(:opts)
  ...
  def self.read_url(url)
    ...
    raise Admin::Source::Parser::HttpAuthenticationRequiredError.new
  end
  ...
  def to_events_api_helper(url, error_key="error", &block)
    ...
    raise Admin::Source::Parser::NotFound, error if error = data[error_key]
...
require 'admin/source/parser/not_found'
require 'admin/source/parser/plancast'
require 'admin/source/parser/meetup'
require 'admin/source/parser/facebook'
require 'admin/source/parser/ical'
require 'admin/source/parser/hcal'
